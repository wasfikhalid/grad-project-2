...
with tab4:
    ...
    if x_col == y_col:
        ...
        # Deduplicate columns so x_col == c_col or y_col == c_col doesn't crash narwhals
        cols_needed = list(dict.fromkeys([x_col, y_col, c_col]))
        samp = df_day[cols_needed].dropna().sample(min(scatter_n, len(df_day)), random_state=0)
